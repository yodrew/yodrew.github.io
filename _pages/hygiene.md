...
We will learn these lines---these principles---in this chapter. Which relates the basic theory of hygiene. The next chapter, **darkroom retreat**, relates the application of hygiene to darkness. In chapter 3, we head into the uncharted depths of hygienic **psychology**.
...
Likewise, heroic discipline or super-effort (doing something twice as much or twice as fast) have the notable but still insignificant effect of turning people into weird assholes. Common examples include religiosity[^5] about a god, politics, work, and food. Fortunately, this condition abates with enough rest.
...
Life equips us with everything we need to live fully. This seems to be about 50 times more than we need to just survive. Which is good because we seem to have lost 98% of it. So even our huge starting margin is proving insufficient. In our permanent state of emergency and distress, a major crisis or two can kill most of us.
...
Thus the organism constantly works for perfect health. As long as health is imperfect and the conditions of healing remain present, the organism, by its nature, must continue healing till the goal is reached.
...
This is the general theory of hygiene 3.0. Now we can better apprehend our main subject, darkroom retreating, in the next chapter.
...
[^4]: ibid, p103
[^5]: religion, Latin, re (_again_) + leg (_law_), an internal binding to law. It is a desperate act, making people strange.

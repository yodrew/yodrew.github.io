...
For your next trick: blacking out windows. I have tried about 10 methods of covering windows for lightproofness in ~100 spaces over the past 15 years. Two work well just about everywhere in nearly every way.

The double-blind is the new standard for quick, easy blackout blinds. The panel is a modern revival of traditional shutters.

Images and instructions follow constraints, comments, and a lesson on windows.

Notes on retired methods—foil, velcro, roller blind—are at the end.
...
4. pro-tips
	...
	- use one layer of tape except for tacking and overlapped ends. One layer flexes as what it is taped to expands and contracts with heat and moisture. Multiple layers of tape are rigid. It peels, opening cracks for light to get through.

#### single

Single-layer: extra-thick (0.25-) material, either black polyethylene construction sheeting, available at concrete supply houses, or EPDM rubber, used for pond lining and roofs.

This is tricky. A single layer requires the most precision. You will need lightproof tape or especially careful taping. Extend plastic far beyond trim (150--200-). Fold edge under to create a springy seal. Or use fleece seals, especially for rough surfaces. Avoid nicking and puncturing it. Repair with black tape or patches. The double-blind is better in most cases.
